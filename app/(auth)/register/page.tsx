...
export default function RegisterPage() {
  ...
  async function handleRegister(e: React.FormEvent) {
    ...
    setError('')
    try {
      const user = await registerUser(email, password, displayName, role, schoolId)
    ...
    <div className="min-h-screen flex items-center justify-center bg-black">
      ...
      <div className="relative w-full max-w-md px-4">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-zinc-400 text-sm mb-7">Join EduTrack as a student, teacher, or admin</p>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Clinton Akinwoleola"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition appearance-none cursor-pointer"
              >
